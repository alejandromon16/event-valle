...
interface RequestEventCardProps {
  title: string;
  subtitle: string;
  description: string;
  startDate: string;
...
const RequestEventCard: React.FC<RequestEventCardProps> = ({
  title,
  subtitle,
  description,
  startDate,
...
const RequestEventPage: React.FC<PageProps> = ({ params }) => {
